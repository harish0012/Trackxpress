...
export const Login = () => {
  ...
  return (
    ...
    <form action="" id={style.for}>
      ...
      <br />
      <input type="text" id={style.username1} placeholder="username" onChange={(e)=>{
      ...
      <br />
      <input type="number" id={style.password} placeholder="password" onChange={(e)=>{
    ...
    <p>Don't have an account? <Link to={'/signup'} id={style.lin}>Register</Link></p>
    </div>
    </div>
    </>
  )
